...
On the backend side of this project, I created the database for storing statuses (presence or absence of COVID symptoms). My initial drawing for my idea of the database design is shown in the picture on the right. Additionally, I also worked on creating the page with the form to add a status. 
